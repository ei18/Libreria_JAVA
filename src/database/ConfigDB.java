...
public class ConfigDB {
    ...
    public static Connection openConnection(){
        try {
            ...
            String url = "jdbc:mysql://b5gcmsgldng07qzabxgv-mysql.services.clever-cloud.com:3306/b5gcmsgldng07qzabxgv";
            String user = "ue6vyipwdhhxicgq";
            String password = "BmLlvgQozAVEiZUiWpO7";
